...
<div class="page-content">
    <div class="container-fluid">
        ...
        <div class="bg-white table-responsive rounded shadow-sm pt-3 pb-3 mb-30">
            ...
            <?php endif;?>
            <table id="data-table" class="table table-striped table-sm table-bordered table-responsive" cellspacing="0" width="100%">
                ...
                <tbody>
                    <?php foreach($table['aportes'] as $key=>$item): ?>   
                        <tr>                 
                            <td class="text-left" style="width:20%"> <?php echo $item['fullname']?> </td>
