                ...
                <?php echo form_open($action,array('method'=>'post')); ?>
                   ...
                   <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="date" pattern="[0-9]{2}-[0-9]{2}-[0-9]{4}-" class="form-control" id="date_pago" name="date_pago" value="<?php echo set_value('date_added'); ?>" placeholder="Fecha de Comienzo de Pago ">
                        </div>
                        <div class="col-sm-4">
                            <label id="date_pago-error" class="error" for="date_pago"><?php echo form_error('date_added'); ?></label>
                        </div>
                    </div>
